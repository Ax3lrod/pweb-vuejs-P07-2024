<template>
  <div class="form-container">
    <form @submit.prevent="handleAddBook" class="p-5 border rounded shadow">
      ...
      <div class="mb-4">
        <label for="publishedDate" class="block font-medium">Tanggal Terbit</label>
        <input
      ...
      <div class="mb-4">
        <label for="coverImage" class="block font-medium">Gambar Sampul (URL)</label>
        <input
